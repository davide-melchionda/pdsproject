========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto fileshare-mainprocess
========================================================================

La creazione guidata applicazione ha creato questa applicazione fileshare-mainprocess.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione fileshare-mainprocess.


fileshare-mainprocess.vcxproj
...
fileshare-mainprocess.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato fileshare-mainprocess.pch e il file dei tipi precompilato StdAfx.obj.
